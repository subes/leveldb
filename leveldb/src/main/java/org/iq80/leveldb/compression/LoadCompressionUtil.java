...
final class LoadCompressionUtil
{
    private LoadCompressionUtil()
    {
        //internal util
    }

    static Compression loadCompression(String key, String defaultValues)
    {
        Compression attempt = null;
        String[] factories = System.getProperty(key, defaultValues).split(",");
